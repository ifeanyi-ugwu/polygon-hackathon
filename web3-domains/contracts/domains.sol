...
contract Domains is ERC721URIStorage{
  //Wisdom given to us by OpenZeppelin to help us keep track of tokenIds.
  ...
  constructor(string memory _tld) ERC721("Havilah Name Service", "HNS") payable {
  ...
  function register(string calldata name) public payable {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"name": "',
        _name,
        '", "description": "A domain on the Havilah name service", "image": "data:image/svg+xml;base64,',
    ...
    _setTokenURI(newRecordId, "ipfs://QmWY9tCJoBBRfs9HE1SSBZQHLjgj9nmuH9ByvnsGJoaTwC");
  ...
  function getAddress(string calldata name) public view returns (address) {
    ...
    function setRecord(string calldata name, string calldata record) public {
      // This is to check that the owner is the transaction sender
